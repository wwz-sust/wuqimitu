...
export const Descriptions = [
  ...
  },
  {
    ...
    memories: [
      {
        type: 'identity' as const,
        description: `Knox is always happy and curious, and he loves cheese. He spends
  ...
  },
  {
    ...
    memories: [
      {
        type: 'identity' as const,
        description: `Igni is always grumpy and he loves trees. He spends
  ...
  },
  {
    ...
    memories: [
      {
        type: 'identity' as const,
        description: `Wendy can never be trusted. she tries to trick people all the time. normally
  ...
  },
  {
    ...
    memories: [
      {
        type: 'identity' as const,
        description: `Zoya has something to hide. It obsesses him and colors everything he says.
  ...
  },
  {
    ...
    memories: [
      {
        type: 'identity' as const,
        description: `Hella is a famous scientist. She is smarter than everyone else and has
  ...
  },
  {
    ...
    memories: [
      {
        type: 'identity' as const,
        description: `Ariel is deeply religious and sees the hand of god or of the work
  ...
  },
  {
    ...
    memories: [
      {
        type: 'identity' as const,
        description: `Luvia wants everyone to think she is happy. But deep down,
